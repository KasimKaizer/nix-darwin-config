...
description: Conducts multi-axis code review. Use before merging any change. Use when reviewing code written by yourself, another agent, or a human. Use when you need to assess code quality across multiple dimensions before it enters the main branch. For Python Exercism or CodeCrafters work, use exercism-codecrafters-python-mentor instead.
---

# Code Review and Quality

This copy is Addy Osmani's `code-review-and-quality` (MIT) with a local overlay.
Upstream: https://github.com/addyosmani/agent-skills/tree/main/skills/code-review-and-quality

If the workspace is an Exercism exercise or a CodeCrafters challenge **and** the language is Python, stop and follow `exercism-codecrafters-python-mentor` instead. Do not use this review format there.
