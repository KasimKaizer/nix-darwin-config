...
This copy is Addy Osmani's `debugging-and-error-recovery` (MIT) with a local overlay.
Upstream: https://github.com/addyosmani/agent-skills/tree/main/skills/debugging-and-error-recovery

Use `verification-before-completion` before claiming the bug is fixed or that tests pass.
