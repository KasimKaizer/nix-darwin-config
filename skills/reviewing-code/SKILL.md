---
name: reviewing-code
description: Perform a thorough code review focused on correctness, maintainability, performance, and best practices. Use when reviewing pull requests, examining code changes, or when the user asks for a code review. For Python Exercism or CodeCrafters work, use exercism-codecrafters-python-mentor instead.
---
