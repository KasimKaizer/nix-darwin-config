---
name: creating-pr
description: Create a clean, review-ready pull request with a good title, structured description, linked issues, and appropriate reviewers. Use when the user asks to open a PR, create a pull request, or package work for review.
---
...
- Verify tests pass with the project's test command
- Verify lint/format with the project's tools
