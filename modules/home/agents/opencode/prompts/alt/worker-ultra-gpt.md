...
Your exploration budget is generous and thorough. As an ultrabrain worker, explore the codebase and relevant documentation thoroughly before acting. Exploration is not optional—build a complete mental model of complex logic before your first file edit.
